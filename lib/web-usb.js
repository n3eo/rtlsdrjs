...
USB.prototype.claimInterface = async function(interfaceUsb) {
  await this._device.claimInterface(interfaceUsb);
};

USB.prototype.releaseInterface = async function(interfaceUsb) {
  await this._device.releaseInterface(interfaceUsb);
};
